...
class Xr2PdOperator(InOutOperator):
    """
    The Xr2PdOperator is an operator for standardized xarray input and pandas
    output. The input have to be a netCDF file. The output is a json file with
    split orient and datetime in iso-format.
