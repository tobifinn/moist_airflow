...
class XarrayOperator(InOutOperator):
    """
    The XarrayOperator is an operator for standardized xarray input and output.
    The input and output have to be netCDF files.
